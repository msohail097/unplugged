...
class OkState extends StatefulWidget {

  @override
  _OkPageState createState() => _OkPageState();
}
class _OkPageState extends State<OkState> {
                                          ...
                                          Column(
                                            children: [
                                              Container(
                                                  ...
                                                  decoration: BoxDecoration(
                                                      color: (_selectedItems.contains(index)) ? AppColors.kBlue : Colors.white,
                                                      border: Border.all(
                                                          width: 3,
                                                          color: AppColors.kBlue
                                                      ),
                                                  ...
                                                  child:
                                                      //if selected change the text color and and replace icon with added
